...
function wp_spp_sync_group_post_option( $post )	{
	if ( wp_spp_post_can_be_grouped( $post ) )	{
		...
		<div class="misc-pub-section">
			<span class="dashicons dashicons-update" style="color: #82878c;"></span>
            <?php _e( 'Post Sync Group', 'synchronized-post-publisher' ); ?>
            <a href="#wp_spp_select_group" class="edit-group hide-if-no-js"><span aria-hidden="true"><?php _e( 'Edit', 'synchronized-post-publisher' ); ?></span> <span class="screen-reader-text"><?php _e( 'Edit sync group', 'synchronized-post-publisher' ); ?></span></a>
